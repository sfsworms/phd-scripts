...
## This create a data frame containing the well numbers (wellID) as well as the
## well names (wellName) from a plate.xlsx file in folder_loc.It assumes that well
## marked with 'x' are empty and discard them.  It then merge that info with
## tecan_data
...
## This put all together to reorganise the data.
